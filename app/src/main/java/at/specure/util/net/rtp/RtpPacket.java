...
public class RtpPacket {
	...
	public RtpPacket(RealtimeTransportProtocol.PayloadType payloadType, int csrcCount, long[] csrc, int seqNumber, long timeStamp, long ssrc) {
		this(payloadType, csrcCount, csrc, seqNumber, timeStamp, ssrc, null);
	}
	
	public RtpPacket(RealtimeTransportProtocol.PayloadType payloadType, int csrcCount, long[] csrc, int seqNumber, long timeStamp, long ssrc, byte[] payload) {
		this.header = RealtimeTransportProtocol.createHeaderBytes(RealtimeTransportProtocol.RtpVersion.VER2, false, false,
	...
	public RtpPacket(byte[] packet) throws RealtimeTransportProtocol.RtpException {
	...
	public RealtimeTransportProtocol.PayloadType getPayloadType() {
		return RealtimeTransportProtocol.PayloadType.getByCodecValue(header[1] & 0x7F);
	}
	 ...
	 * @param version
	 */
	public void setVersion(RealtimeTransportProtocol.RtpVersion version) {
