package at.specure.util.tools.expandablerecyclerview;
...
import at.specure.util.tools.expandablerecyclerview.listeners.ExpandCollapseListener;
import at.specure.util.tools.expandablerecyclerview.listeners.GroupExpandCollapseListener;
...
import at.specure.util.tools.expandablerecyclerview.models.ExpandableList;
import at.specure.util.tools.expandablerecyclerview.models.ExpandableListPosition;
...
public abstract class ExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
  ...
  private boolean forceExpandedGroups = false;
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public boolean isForceExpandedGroups() {
        return forceExpandedGroups;
    }
...
//        }
  ...
  public boolean isGroupExpanded(ExpandableGroup group) {
    ...
    public void setGroupExpanded(ExpandableGroup group) {
        expandCollapseController.setGroupExpanded(group);
    }
  ...
  public void setForceExpandedGroups(boolean forceExpandedGroups) {
    this.forceExpandedGroups = forceExpandedGroups;
    if (forceExpandedGroups) {
        List<? extends ExpandableGroup> groups = expandableList.groups;
        for (ExpandableGroup group : groups) {
            setGroupExpanded(group);
        }
    }
  }
}
