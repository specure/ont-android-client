 ...
 */
package at.specure.minidns.java7.dane.java7;
...
import at.specure.minidns.dnssec.dane.DaneVerifier;
...
public class DaneExtendedTrustManager extends X509ExtendedTrustManager {
    ...
    public static void inject(Context context) {
        inject(new DaneExtendedTrustManager(context));
    }
    ...
    public DaneExtendedTrustManager(Context context) {
        this(context, getDefaultTrustManager());
    }
    ...
    public DaneExtendedTrustManager(Context context, X509TrustManager base) {
        this(new DaneVerifier(context), base);
    }
