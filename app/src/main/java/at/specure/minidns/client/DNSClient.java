...
import at.specure.minidns.android21.dnsserverlookup.android21.AndroidUsingLinkProperties;
import at.specure.minidns.client.dnsserverlookup.AndroidUsingExec;
import at.specure.minidns.client.dnsserverlookup.AndroidUsingReflection;
import at.specure.minidns.client.dnsserverlookup.DNSServerLookupMechanism;
import at.specure.minidns.client.dnsserverlookup.UnixUsingEtcResolvConf;
import at.specure.minidns.core.DNSMessage;
import at.specure.minidns.core.util.CollectionsUtil;
import at.specure.minidns.core.util.ExceptionCallback;
import at.specure.minidns.core.util.InetAddressUtil;
import at.specure.minidns.core.util.MultipleIoException;
import at.specure.minidns.core.util.SuccessCallback;
...
public class DNSClient extends AbstractDNSClient {
    ...
    public DNSClient(Context context, DNSCache dnsCache) {
    ...
    private void initialize() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            addDnsServerLookupMechanism(AndroidUsingLinkProperties.getInstance(super.context));
        } else {
