...
public class UNKNOWN extends Data {
    ...
    private UNKNOWN(DataInputStream dis, int payloadLength, Record.TYPE type) throws IOException {
        this.type = type;
    ...
    public static UNKNOWN parse(DataInputStream dis, int payloadLength, Record.TYPE type)
            throws IOException {
