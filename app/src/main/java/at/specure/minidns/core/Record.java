 ...
 */
package at.specure.minidns.core;
...
import at.specure.minidns.core.record.DLV;
import at.specure.minidns.core.record.DNAME;
import at.specure.minidns.core.record.DNSKEY;
import at.specure.minidns.core.record.DS;
...
import at.specure.minidns.core.record.NSEC;
import at.specure.minidns.core.record.NSEC3;
import at.specure.minidns.core.record.NSEC3PARAM;
import at.specure.minidns.core.record.OPENPGPKEY;
import at.specure.minidns.core.record.OPT;
import at.specure.minidns.core.record.PTR;
import at.specure.minidns.core.record.RRSIG;
import at.specure.minidns.core.record.SOA;
import at.specure.minidns.core.record.SRV;
import at.specure.minidns.core.record.TLSA;
import at.specure.minidns.core.record.TXT;
import at.specure.minidns.core.record.UNKNOWN;
...
public final class Record<D extends Data> {
    ...
    public static enum TYPE {
        ...
        MD(3),
        MF(4),
        CNAME(5, at.specure.minidns.core.record.CNAME.class),
        SOA(6, SOA.class),
        MB(7),
        MG(8),
        MR(9),
        ...
        MINFO(14),
        MX(15, MX.class),
        TXT(16, at.specure.minidns.core.record.TXT.class),
        RP(17),
        AFSDB(18),
        X25(19),
        ISDN(20),
        ...
        SINK(40),
        OPT(41, at.specure.minidns.core.record.OPT.class),
        APL(42),
        DS(43, DS.class),
        SSHFP(44),
        IPSECKEY(45),
        RRSIG(46, at.specure.minidns.core.record.RRSIG.class),
        NSEC(47, NSEC.class),
        DNSKEY(48, at.specure.minidns.core.record.DNSKEY.class),
        DHCID(49),
        NSEC3(50, NSEC3.class),
        NSEC3PARAM(51, at.specure.minidns.core.record.NSEC3PARAM.class),
        TLSA(52, TLSA.class),
        HIP(55),
        NINFO(56),
        RKEY(57),
