...
import at.specure.minidns.core.edns.EDNSOption;
import at.specure.minidns.core.edns.UnknownEDNSOption;
...
public class EDNS {
    ...
    public enum OptionCode {
        ...
        NSID(3, at.specure.minidns.core.edns.NSID.class),;
    ...
    public static EDNS fromRecord(Record<? extends Data> record) {
        if (record.type != Record.TYPE.OPT) return null;
