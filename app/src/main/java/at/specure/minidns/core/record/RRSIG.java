...
import at.specure.minidns.core.util.Base64;
...
public class RRSIG extends Data {
    ...
    private RRSIG(Record.TYPE typeCovered, DNSSECConstants.SignatureAlgorithm algorithm, byte algorithmByte, byte labels, long originalTtl, Date signatureExpiration,
    ...
    public RRSIG(Record.TYPE typeCovered, int algorithm, byte labels, long originalTtl, Date signatureExpiration,
                 Date signatureInception, int keyTag, DNSName signerName, byte[] signature) {
    ...
    public RRSIG(Record.TYPE typeCovered, DNSSECConstants.SignatureAlgorithm algorithm, byte labels,
