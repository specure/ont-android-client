...
public abstract class AbstractQoSTask extends AbstractRMBTTest implements QoSTask {
	...
	public AbstractQoSTask(QualityOfServiceTest nnTest, TaskDesc taskDesc, int threadId, int id, int priority) {
		...
		JsonPrimitive jsonPrimitive = (JsonPrimitive) taskDesc.getParams().get(PARAM_QOS_TEST_OBJECTIVE_ID);
		if (jsonPrimitive != null) {
			String value = jsonPrimitive.getAsString();
			this.qoSTestObjectiveUid = !TextUtils.isEmpty(value) ? Long.valueOf(value) : null;
		}
		jsonPrimitive = (JsonPrimitive) taskDesc.getParams().get(PARAM_QOS_TEST_OBJECTIVE_PORT);
		if (jsonPrimitive != null) {
			String value = jsonPrimitive.getAsString();
			this.serverPort = !TextUtils.isEmpty(value) ? Integer.valueOf(value) : null;
		}
		jsonPrimitive = (JsonPrimitive) taskDesc.getParams().get(PARAM_QOS_CONCURRENCY_GROUP);
		if (jsonPrimitive != null) {
			String value = jsonPrimitive.getAsString();
			this.concurrencyGroup = !TextUtils.isEmpty(value) ? Integer.valueOf(value) : 0;
		}
		jsonPrimitive = (JsonPrimitive) taskDesc.getParams().get(PARAM_QOS_TEST_OBJECTIVE_ADDRESS);
		if (jsonPrimitive != null) {
			String value = jsonPrimitive.getAsString();
	...
	/*
	 * (non-Javadoc)
	 * @see at.specure.client.v2.task.QoSTask#getPriority()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see at.specure.client.v2.task.QoSTask#getTestServerPort()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see at.specure.client.v2.task.QoSTask#getTestServerAddr()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see at.specure.client.v2.task.QoSTask#getQoSObjectiveTestId()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see at.specure.client.v2.task.QoSTask#getConcurrencyGroup()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see at.specure.client.v2.task.QoSTask#getTaskDesc()
	 */
