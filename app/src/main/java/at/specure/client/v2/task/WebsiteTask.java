...
public class WebsiteTask extends AbstractQoSTask {
    ...
    public WebsiteTask(QualityOfServiceTest nnTest, TaskDesc taskDesc, int threadId) {
        ...
        String value = null;
        if (taskDesc.getParams().containsKey(PARAM_URL)) {
            value = ((JsonElement) taskDesc.getParams().get(PARAM_URL)).getAsString();
        }
    ...
    /*
     * (non-Javadoc)
     * @see at.specure.client.v2.task.AbstractQoSTask#initTask()
     */
    @Override
