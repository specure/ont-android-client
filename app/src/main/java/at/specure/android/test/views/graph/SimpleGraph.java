...
/**
 * Used for speed and signal changes in time
 */
public class SimpleGraph implements GraphService
{
    ...
    private SimpleGraph(final int color, final long maxNsecs, final float width, final float height, final float strokeWidth)
    {
        ...
        paintFill.setShader(new LinearGradient(0, 0, 0, height, color, Color.WHITE, Shader.TileMode.CLAMP));
    ...
    /*
     * (non-Javadoc)
     * @see at.specure.android.test.Graph#addValue(double, double)
     */
    public void addValue(double value, double time) {
        ...
        final float x = (float) (nsecWidth * time);
        if (values == 0)
        {
            startX = x;
    ...
    /*
     * (non-Javadoc)
     * @see at.specure.android.views.graphview.GraphService#addValue(double, double, int)
     */
	...
	/*
	 * (non-Javadoc)
	 * @see at.specure.android.views.graphview.GraphService#addValue(double, int)
	 */
    ...
    /*
     * (non-Javadoc)
     * @see at.specure.android.test.Graph#addValue(double)
     */
    // 0 <= value <= 1
	...
	/*
	 * (non-Javadoc)
	 * @see at.specure.android.views.graphview.GraphService#getGraphData()
	 */
	@Override
