...
public class TestService extends android.app.Service implements EndTaskListener
{
    ...
    public void onCreate()
    {
        ...
        loopMode = LoopModeConfig.isLoopMode(this);
    ...
    public int onStartCommand(final Intent intent, final int flags, final int startId)
    {
        ...
        if (ACTION_START_TEST.equals(action) || ACTION_LOOP_TEST.equals(action))
        {
            ...
            if (ACTION_LOOP_TEST.equals(action)) {
                LoopModeConfig.incrementCurrentTestNumber(getApplicationContext());
            }
            testTask = new TestTask(getApplicationContext());
