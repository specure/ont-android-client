...
public class VoipTestResult {
     ...
     * defined in @{@link at.specure.android.constants.TestResultConst}}
     */
    ...
    public String getMeanJitter() {
        ...
        if ((resultInMeanJitter != null) && (resultOutMeanJitter != null)) {
            ...
            meanJitterFormattedString = SpeedTestStatViewController.InfoStat.JITTER.format(meanJitter);
        }
    ...
    public String getMeanPacketLossInPercent() {
        ...
        if ((packetLossDown >= 0) && (packetLossUp >= 0)) {
            ...
            packetLossStr = SpeedTestStatViewController.InfoStat.PACKET_LOSS_DOWN.format(meanPacketLoss);
        }
