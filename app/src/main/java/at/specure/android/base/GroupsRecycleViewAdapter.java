...
/**
 * This class is suitable for group list
 */
public class GroupsRecycleViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GroupsRecycleViewAdapter() {
