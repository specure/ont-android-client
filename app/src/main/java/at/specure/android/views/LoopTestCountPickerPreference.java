...
public class LoopTestCountPickerPreference extends ExtendedDialogPreferenceCompat {
    private NumberPicker mPicker;
    private int defaultValue = getContext().getResources().getInteger(R.integer.default_loop_max_tests);
    private int mNumber;

    public LoopTestCountPickerPreference(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        // required for use in XMLs
    }


    public LoopTestCountPickerPreference(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDialogOpened(View rootView) {
        ...
        mPicker.setMaxValue(getContext().getResources().getInteger(R.integer.default_loop_max_tests));
    ...
    protected Object onGetDefaultValue(TypedArray a, int index) {
        return super.onGetDefaultValue(a, getContext().getResources().getInteger(R.integer.default_loop_max_tests));
    }
