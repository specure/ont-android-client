 ...
 ******************************************************************************/
package at.specure.android.screens.result.views;
...
public class QoSTestDetailView extends ScrollView {
	...
	public QoSTestDetailView(Context context, MainActivity activity, QoSServerResult result, List<QoSServerResultDesc> descList) {
		super(context);
	...
	public View createView(LayoutInflater inflater, ViewGroup container) {
        ...
        LinearLayout successListView = view.findViewById(R.id.value_list_success);
        ...
        LinearLayout failureListView = view.findViewById(R.id.value_list_fail);
        ...
        if (failureList.size() > 0) {
        	if (QoSServerResult.ON_FAILURE_BEHAVIOUR_INFO_SUCCESS.equals(result.getOnFailureBehaviour())) {
                ...
                TextView textSuccess = view.findViewById(R.id.subheader_text_success);
                if (textSuccess != null) {
	...
	protected Parcelable onSaveInstanceState() {
        ...
        outState.putSerializable(BUNDLE_QOS_RESULT, result);
