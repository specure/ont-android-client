...
package at.specure.android.screens.test_results;
...
public class VoipTestResultHandler {
    ...
    public String getMeanJitterTitleString(Context context) {
        String string = context.getResources().getString(R.string.test_bottom_test_status_jitter);
        return string;
    }

    public String getMeanPacketLossString(Context context) {
        String string = context.getResources().getString(R.string.test_packet_loss);
        return string;
    }
