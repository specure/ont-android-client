...
import at.specure.client.v2.task.result.QoSServerResultTestDesc;
...
public class QoSCategoryView extends ScrollView implements OnClickListener {
	...
	public QoSCategoryView(Context context, MainActivity activity, QoSServerResultTestDesc testDesc, List<QoSServerResult> resultList, List<QoSServerResultDesc> descList) {
		super(context);
	...
	public View createView(LayoutInflater inflater, ViewGroup container) {
        ...
        ViewGroup listView = view.findViewById(R.id.valueList);
        ...
        TextView infoText = testInfo.findViewById(R.id.name);
	...
	protected Parcelable onSaveInstanceState() {
        ...
        outState.putSerializable(BUNDLE_QOS_TEST_DESC, testDesc);
