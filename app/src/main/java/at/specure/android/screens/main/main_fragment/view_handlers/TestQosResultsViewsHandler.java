...
/**
 * Class handling UI for QoS test results mode state of the main screen fragment
 * Created by michal.cadrik on 10/12/2017.
 */

public class TestQosResultsViewsHandler extends ViewsHandler {


    public TestQosResultsViewsHandler(View rootView, HashMap<Integer, View.OnClickListener> onClickListeners) {
        ...
        this.viewsToSetVisible.add(R.id.test_view_qos_results_container);
