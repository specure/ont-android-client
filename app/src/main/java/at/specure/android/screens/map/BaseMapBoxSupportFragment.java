 ...
 */
public class BaseMapBoxSupportFragment extends BaseFragment implements OnMapReadyCallback {
     ...
     */
    public static BaseMapBoxSupportFragment newInstance() {
        return new BaseMapBoxSupportFragment();
    }
     ...
     * @return MapFragment created.
     */
    public static BaseMapBoxSupportFragment newInstance(@Nullable MapboxMapOptions mapboxMapOptions) {
        BaseMapBoxSupportFragment mapFragment = new BaseMapBoxSupportFragment();
