...
public class AppConstants {
	...
	static {
		...
		TITLE_MAP.put(PAGE_TITLE_MAIN, null);
	...
	public static String getUserAgentString(Context context) {
		...
		try {
			...
			return "SpecureNetTest/2.0 (Android; " + Locale.getDefault().toString()  + "; API" + Build.VERSION.SDK_INT + ") SpecureNetTest/" + pInfo.versionCode;
