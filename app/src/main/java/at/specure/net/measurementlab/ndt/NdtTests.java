...
package at.specure.net.measurementlab.ndt;
...
public class NdtTests implements Runnable {
  ...
  public NdtTests(String host, UiServices uiServices, String networkType) {
    ...
    try {
      messages = PropertyResourceBundle.getBundle("assets.Tcpbw100_msgs", Locale.getDefault());
...
//      messages = ResourceBundle.getBundle("net.measurementlab.ndt.Tcpbw100_msgs", new Locale("en", "US"));
      messages = PropertyResourceBundle.getBundle("assets.Tcpbw100_msgs", new Locale("en", "US"));
    }
  }
